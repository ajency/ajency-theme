...
"use strict";
var AjencyWpThemeGenerator, app, askFor, chalk, path, util, yeoman;
...
AjencyWpThemeGenerator = module.exports = AjencyWpThemeGenerator = function(args, options, config) {
...
AjencyWpThemeGenerator.prototype.askFor = askFor = function() {
  var cb, prompts;
  cb = this.async();
...
AjencyWpThemeGenerator.prototype.app = app = function() {
  var currentDate;
